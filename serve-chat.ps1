$tcp = New-Object System.Net.Sockets.TcpListener([System.Net.IPAddress]::Loopback, 8080)
$tcp.Start()
Write-Host 'Server running at http://localhost:8080/ai-chat.html'
while ($true) {
